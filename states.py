...
class State:
    ...
    def process(self, dt): return PlayerStates.NULL

    def process_physics(self, dt): return PlayerStates.NULL
...
class DashState(RunState):
    DASHTIME = 0.4
    def __enter__(self):
        self.current_dash_time = DashState.DASHTIME
        self.
...
def calculate_x_velocity(entity, dt):
    ...
    if dir < 0:
        ...
        if sign(u) == -1:
            ...
            return max(u - v, target_speed*dir)

...
class Population:
    ...
    def get_distance_between_2_genomes(self, genome1, genome2):
        ...
        return self.get_number_of_excess_and_disjoint_connection_genes(genome1, genome2) +  get_average_enabled_weight_difference(genome1, genome2)
